...
| 【精简版】[boot-mini](https://gitee.com/yudaocode/boot-mini) | [`master`](https://gitee.com/yudaocode/boot-mini/tree/master/) 分支   | [`master-jdk17`](https://gitee.com/yudaocode/boot-mini/tree/master-jdk17/) 分支   | [`master-jdk25`](https://gitee.com/yudaocode/boot-mini/tree/master-jdk25/) 分支   |
...
| [cloud](https://gitee.com/zhijiantianya/cloud)      | [![Gitee star](https://gitee.com/zhijiantianya/cloud/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/cloud) [![GitHub stars](https://img.shields.io/github/stars/YunaiV/cloud.svg?style=social&label=Stars)](https://github.com/YunaiV/cloud)               | 基于 Spring Cloud 微服务架构       |
| [Spring-Boot-Labs](https://gitee.com/yudaocode/SpringBoot-Labs) | [![Gitee star](https://gitee.com/yudaocode/SpringBoot-Labs/badge/star.svg?theme=white)](https://gitee.com/zhijiantianya/cloud) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/SpringBoot-Labs.svg?style=social&label=Stars)](https://github.com/yudaocode/SpringBoot-Labs) | 系统学习 Spring Boot & Cloud 专栏 |

### 前端项目

| 项目                                                                         | Star                                                                                                                                                                                                                                                                                                                     | 简介                                     |
|----------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| [ui-admin-vue3](https://gitee.com/yudaocode/ui-admin-vue3)     | [![Gitee star](https://gitee.com/yudaocode/ui-admin-vue3/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ui-admin-vue3) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ui-admin-vue3.svg?style=social&label=Stars)](https://github.com/yudaocode/ui-admin-vue3)         | 基于 Vue3 + element-plus 实现的管理后台         |
| [ui-admin-vben](https://gitee.com/yudaocode/ui-admin-vben)     | [![Gitee star](https://gitee.com/yudaocode/ui-admin-vben/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ui-admin-vben) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ui-admin-vben.svg?style=social&label=Stars)](https://github.com/yudaocode/ui-admin-vben)         | 基于 Vue3 + vben(ant-design-vue) 实现的管理后台 |
| [mall-uniapp](https://gitee.com/yudaocode/mall-uniapp)         | [![Gitee star](https://gitee.com/yudaocode/mall-uniapp/badge/star.svg?theme=white)](https://gitee.com/yudaocode/mall-uniapp) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/mall-uniapp.svg?style=social&label=Stars)](https://github.com/yudaocode/mall-uniapp)                 | 基于 uni-app 实现的商城小程序                    |
| [ui-admin-vue2](https://gitee.com/yudaocode/ui-admin-vue2)     | [![Gitee star](https://gitee.com/yudaocode/ui-admin-vue2/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ui-admin-vue2) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ui-admin-vue2.svg?style=social&label=Stars)](https://github.com/yudaocode/ui-admin-vue2)         | 基于 Vue2 + element-ui 实现的管理后台           |
| [ui-admin-uniapp](https://gitee.com/yudaocode/ui-admin-uniapp) | [![Gitee star](https://gitee.com/yudaocode/ui-admin-uniapp/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ui-admin-uniapp) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ui-admin-uniapp.svg?style=social&label=Stars)](https://github.com/yudaocode/ui-admin-uniapp) | 基于 Vue2 + element-ui 实现的管理后台           |
| [ui-go-view](https://gitee.com/yudaocode/ui-go-view)           | [![Gitee star](https://gitee.com/yudaocode/ui-go-view/badge/star.svg?theme=white)](https://gitee.com/yudaocode/ui-go-view) [![GitHub stars](https://img.shields.io/github/stars/yudaocode/ui-go-view.svg?style=social&label=Stars)](https://github.com/yudaocode/ui-go-view)                     | 基于 Vue3 + naive-ui 实现的大屏报表             |
...
| `module-member` | 会员中心的 Module 模块    |
| `module-infra`  | 基础设施的 Module 模块    |
| `module-bpm`    | 工作流程的 Module 模块    |
| `module-pay`    | 支付系统的 Module 模块    |
| `module-mall`   | 商城系统的 Module 模块    |
| `module-erp`    | ERP 系统的 Module 模块  |
| `module-crm`    | CRM 系统的 Module 模块  |
| `module-mes`    | MES 系统的 Module 模块  |
| `module-wms`    | WMS 系统的 Module 模块  |
| `module-hrm`    | HRM 人力资源管理的 Module 模块 |
| `module-fms`    | FMS 财务管理的 Module 模块 |
| `module-im`     | IM 即时通讯的 Module 模块 |
| `module-ai`     | AI 大模型的 Module 模块  |
| `module-iot`    | IoT 物联网的 Module 模块 |
| `module-mp`     | 微信公众号的 Module 模块   |
| `module-report` | 大屏报表 Module 模块     |
