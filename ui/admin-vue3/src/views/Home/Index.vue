...
const getProject = async () => {
  const data = [
    ...
    },
    {
      ...
      message: 'github.com/yudaocode/ui-admin-vue3',
    ...
    },
    {
      ...
      message: 'github.com/yudaocode/ui-mall-uniapp',
    ...
    },
    {
      ...
      message: 'github.com/YunaiV/cloud',
    ...
    },
    {
      ...
      message: 'github.com/yudaocode/ui-admin-vben',
      personal: 'Vue3 + vben5(antd) 管理后台',
      time: new Date('2025-05-06'),
      color: '#e18525'
    },
    {
      name: 'ui-admin-uniapp',
      icon: 'ant-design:mobile',
      message: 'github.com/yudaocode/ui-admin-uniapp',
